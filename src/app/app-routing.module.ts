...
const routes: Routes = [
  ...
  { path: 'propiedades/:id/mantenimientos', component: MantenimientoListaComponent, pathMatch: 'full'},
  { path: 'propiedades/:id/mantenimientos/editar/:id_mantenimiento', component: MantenimientoEditarComponent, pathMatch: 'full'},
  { path: 'propiedades/:id/mantenimientos/crear', component: MantenimientoCrearComponent, pathMatch: 'full'},
